...
var CALIBRATION_STATE = "calibration";
var NO_INTERFACE_STATE = "no_interface";
var INTERFACE_STATE = "interface";
var STATE = CALIBRATION_STATE;
...
XLabsAnts.prototype.render = function() {
    ...
    if( Gaze.available ) {
        ...
        if (parseFloat( xLabs.getConfig( "state.calibration.confidence" )) > 8) {
            // alert('Calibrated!');
            // STATE = NO_INTERFACE_STATE;
            // Delete ants
            // var self = this;
            // var now = Date.now();
            ...
            // Show video
            document.getElementById("interfaceSwitch").style.visibility='visible';
